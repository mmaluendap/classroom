...
int main(void)
{
	struct USART_configuration config_57600_8N1 = {<agregue los parametros aca>};
	struct USART_configuration config_9600_8N2 = {<agregue los parametros aca>};
	struct USART_configuration config_19200_7N1 = {<agregue los parametros aca>};
	struct USART_configuration config_19200_7E2 = {<agregue los parametros aca>};
